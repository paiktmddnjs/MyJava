...
public class MemberMenu {
	...
	public void deleteAllMember() {
		System.out.println("========= 일괄 회원 삭제 ===========");
		System.out.println("삭제할 회원 수 : ");
		int num = sc.nextInt();
		sc.nextLine();
	...
	public void nameSearchMember() {
		System.out.println("========= 해당 회원 조회 ===========");
		System.out.print("회원의 키워드 : ");
		String keyword = sc.nextLine();
		mc.nameSearchMember(keyword);
	}
